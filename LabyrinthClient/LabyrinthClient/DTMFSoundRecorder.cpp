...
namespace sf
{
	...
	*/
	...
	////////////////////////////////////////////////////////////
	/*
	This method sets recStatus, to indicate wether the recorder
	should analyze or simply delete the recorded data.
	*/
	...
	*/
	...
	////////////////////////////////////////////////////////////
	/*
	This method autoexecutes every 100 ms. It processes the recording.
	*/
	bool DTMFSoundRecorder::onProcessSamples(const Int16* samples, std::size_t sampleCount)
	{
		...
		while (startFlagStatus == 2 && data.size() >= DTMF_tone_length)
		{
			...
			if (GOutput == 2)
			{
				...
				{
					std::cout << "Mode 3: Old message not yet handled" << std::endl; // DEBUG
					break;				// Break to wait
				}
				startFlagStatus = 3;
				endFlagStatus = 0;
